...
namespace YB_StaffingSupervisor.DataAccess.Contract
{
	public interface IMyTeamRepository
	{
        ...
        Task<DataTable> ExportTeamMemberList(string SupervisorUserId, string SearchUserCode, string SearchFullName, string SearchMobileNumber, string SearchEmailId, string SearchDesignation, string SearchJoiningDate);
    }
}
