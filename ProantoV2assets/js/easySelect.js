...
(function($) {
    $.fn.easySelect = function(options) {
        return this.each(function() {
            ...
            var $selectAll = $("<input />", {
                id: 'alleasySelect',
                class: "selectAlleasySelect",
                type: "checkbox",
            }).prependTo($selectAllspan);
            ...
            $selectAll.click(function() {
                if ($('.selectAlleasySelect').is(":checked")) {
            ...
            $("input[type='checkbox'].mulpitply_checkbox_style").change(function() {
                var selectCheck = $("input[type='checkbox'].mulpitply_checkbox_style");
                if (selectCheck.length == selectCheck.filter(":checked").length) {
                    $('.selectAlleasySelect').prop("checked", true);
                } else {
                    $('.selectAlleasySelect').prop("checked", false);
                }
            });

            $('.clearSelectfromDiv').click(function() {
                $('.selectAlleasySelect').prop("checked", false);
            });
